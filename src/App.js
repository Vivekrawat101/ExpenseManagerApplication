...
const dummyExpenses = [
  { id:1 , title: "Food", amount: 1500.49, date: new Date(2018, 9, 14) },
  { id:2 , title: "Home Rent", amount: 3959.99, date: new Date(2019, 6, 12) },
  { id:3 , title: "Internet", amount: 80.18, date: new Date(2024, 1, 13) },
  { id:4 , title: "Personal grooming", amount: 200.19 , date: new Date(2022, 12, 4) }
];
